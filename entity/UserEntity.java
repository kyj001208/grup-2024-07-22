...
public class UserEntity {
	 ...
	 * @ManyToOne
	 * 
	 * @JoinColumn(name = "chatbot_no", referencedColumnName = "chatbot_no") private
	 * ChatbotEntity chatbot;
	 * 
	 * @Enumerated(EnumType.STRING) // DB저장 데이터타입 문자로 저장 : default 숫자로 저장
	 * 
	 * @CollectionTable(name = "role", // RoleEntity 이름 joinColumns
	 * = @JoinColumn(name = "no")) // 선택:자동으로 만들어주지만 fk컬럼명 // member_no
	 * //collection을 Table로 변환시키겠다
	 * 
	 * 
	 */
